...
require('lazy').setup({
  ...
  { -- LSP Configuration & Plugins
    ...
    config = function()
      ...
      original_capabilities = vim.tbl_deep_extend('force', original_capabilities, require('cmp_nvim_lsp').default_capabilities())
  ...
  { -- You can easily change to a different colorscheme.
    ...
    init = function()
      ...
      -- set linenumber color to yellow
      vim.cmd.hi 'LineNr guifg=#FFFF8F'
    end,
  },
...
vim.keymap.set('n', '<leader>ft', function()
  require('utils.terminal').float_term()
